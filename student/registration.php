...
<head>
  ...
  <title>Biblioteka Online| Rejestracja</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><b>Formularz</b></p>
    ...
    <form name="form1" action="" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="telefon" name="contact" required=""/>  
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="kierunek" name="enrollmentno" required=""/>  
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit1" value="Register">Zarejestruj</button>
        </div>
        <!-- /.col -->
      </div>
    </form>

    <a href="login.php" class="text-center">Jestem zajestrowany</a>
    ...
    if(isset($_POST["submit1"]))
    {
        ...
        ?>
            <div class="alert alert-success col-lg-12 col-lg-push-0">
                Dostaniesz email, gdy twoje konto zostanie zaakceptowane
            </div>
        <?php   
    }
?>
