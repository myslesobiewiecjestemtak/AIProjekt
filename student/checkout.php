    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <table class='table responsive table-striped table-bordered table-hover' id='example'>
          ...
          <?php
          $que = "select b.name, b.author, b.publication, b.genre
                  from books b, student_registration s, checkout c
                   where b.idb=c.idb AND s.ids=c.ids AND s.username='$_SESSION[librarian]'";
          ...
          while ($row = mysqli_fetch_array($result)) {
            echo "<tr>";
              ...
              echo "<td>"; ?>  <a href="student_back.php?id=<?php echo $row["idc"]; ?>" onclick="return confirm('Chcesz zwrocic?'); " class="label label-danger" >Zwróć</a> <?php echo "</td>";
            echo "</tr>";
          }
          echo "</table>";
          ?>
