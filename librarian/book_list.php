    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Spis książek</h3>
          <a class='btn btn-primary' href="book_create.php">Dodaj nową</a>
        ...
        <table class='table responsive table-striped table-bordered table-hover' id='example'>
          ...
          while ($row = mysqli_fetch_array($result)) {
            echo "<tr>";
              ...
              echo "<td>"; ?> <a href="book_delete.php?id=<?php echo $row["idb"]; ?>" onclick="return confirm('Chcesz usunac ksiażkę?'); " class="label label-danger" >Delete</a> <?php echo "</td>";
            echo "</tr>";
          }
          echo "</table>";
          ?>
