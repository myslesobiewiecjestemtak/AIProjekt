...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Biblioteka</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"><b>Bibliotekarz Logowanie</b></p>
    ...
    <form name="form1" action="" method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit1" value="Login">Zaloguj</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
